...
// 按需全局引入 vant组件
import Vue from 'vue'
import { Button, Cell, List, Skeleton, Empty, Grid, GridItem, PullRefresh, Tabs, Tab, Search, Icon, NavBar, Sticky, Tabbar, TabbarItem, SwipeCell, Card, Image as VanImage, Lazyload, Dialog, RadioGroup, Radio, Popup } from 'vant'
Vue.use(Button)
Vue.use(Cell)
...
Vue.use(Tabbar)
Vue.use(TabbarItem).use(SwipeCell).use(Card).use(VanImage).use(Lazyload, { lazyComponent: false }).use(Dialog).use(Popup).use(RadioGroup).use(Radio)
